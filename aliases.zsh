...
alias tpy='tmux new-session \; \
  ...
  send-keys -t 0 "nvim ./" C-m'
alias lg="lazygit"
alias bentopdf='echo " > Open http://localhost:3000 to access BentoPDF" && podman run --rm -p 127.0.0.1:3000:8080 --security-opt=no-new-privileges ghcr.io/alam00000/bentopdf:latest'
